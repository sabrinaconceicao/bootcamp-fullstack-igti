...
function renderUsers() {
  ...
  const findName = usersInfo.filter((user) =>
    user.name.toLowerCase().match(nameInput.toLowerCase())
  );
...
function renderStatistics() {
  const totalMasc = usersInfo.filter((user) => user.gender === "male");

  const totalFem = usersInfo.filter((user) => user.gender === "female");
